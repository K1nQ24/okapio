...
- **Dauerbewegung in den Grafiken:** Datenpakete laufen entlang der Linien, Risiko- und Schutzpunkte senden Impulse, gestrichelte Wege (Phishing, gesperrte Verbindung, verworfener Zweig) fließen. Im Hero prallen nach dem Aufbau fortlaufend Angriffspakete am Schild ab.
